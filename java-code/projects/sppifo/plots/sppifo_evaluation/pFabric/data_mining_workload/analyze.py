...
# Packet drop vs. utilization pFabric
    ...
    for x in lambdas:
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/TCP/analysis/statistics.log"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/PIFO/analysis/statistics.log"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "PACKETS_DROPPED" in line:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/SPPIFO/analysis/statistics.log"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "PACKETS_DROPPED" in line:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/XIFO/analysis/statistics.log"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "PACKETS_DROPPED" in line:
