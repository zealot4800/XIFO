...
########################################################################################################################
    ...
    # Mean global flow completion time vs. buffer size reduction pFabric
    lambdas = [4000, 6000, 10000, 15000, 22500, 37000, 60000]
    ...
    for x in lambdas:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/buffer_effect/XIFO_25/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/buffer_effect/XIFO_50/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "all_mean_fct_ms" in line:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/buffer_effect/XIFO_75/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "all_mean_fct_ms" in line:
...
########################################################################################################################
    ...
    # Mean global flow completion time vs. sliding window buffer size pFabric
    lambdas = [4000, 6000, 10000, 15000, 22500, 37000, 60000]
    ...
    for x in lambdas:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/sliding_window_effect/XIFO_16/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "all_mean_fct_ms" in line:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/sliding_window_effect/XIFO_32/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "all_mean_fct_ms" in line:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/sliding_window_effect/XIFO_64/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "all_mean_fct_ms" in line:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/sliding_window_effect/XIFO_128/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "all_mean_fct_ms" in line:
        ...
        file = "temp/sppifo/sppifo_evaluation/pFabric/data_mining_workload/"+str(x)+"/sliding_window_effect/XIFO_256/analysis/flow_completion.statistics"
        r = open(file, 'r')
        lines = r.readlines()
        for i, line in enumerate(lines):
            if "all_mean_fct_ms" in line:
    ...
    w = open('projects/sppifo/plots/sppifo_evaluation/pFabric/data_mining_workload/sliding_window_effect.dat', 'w')
    w.write("#     W=16   W=32   W=64   W=128   W=256  \n")
    w.write("4000   %s    %s   %s   %s   %s   \n" % (FCTs[0][0], FCTs[0][1], FCTs[0][2], FCTs[0][3], FCTs[0][4]))
    w.write("6000   %s    %s   %s   %s   %s   \n" % (FCTs[1][0], FCTs[1][1], FCTs[1][2], FCTs[1][3], FCTs[1][4]))
    w.write("10000   %s    %s   %s   %s   %s   \n" % (FCTs[2][0], FCTs[2][1], FCTs[2][2], FCTs[2][3], FCTs[2][4]))
    w.write("15000   %s    %s   %s   %s   %s   \n" % (FCTs[3][0], FCTs[3][1], FCTs[3][2], FCTs[3][3], FCTs[3][4]))
