...
########################################################################################################################
set output 'projects/sppifo/plots/sppifo_evaluation/pFabric/web_search_workload/pFabric_mean_throughput.pdf'
...
set ytics auto
set key opaque
plot "projects/sppifo/plots/sppifo_evaluation/pFabric/web_search_workload/pFabric_mean_throughput.dat" using 4 title "PIFO" w lp  ls 21 lw 4, \
            '' using 5 title "SP-PIFO"  w lp ls 23 lw 4, \
            '' using 3 title "DCTCP" w lp ls 27 lw 4, \
            '' using 2 title "TCP"  w lp ls 28 lw 4, \
            '' using 6 title "XIFO" w lp ls 29 lw 4
...
########################################################################################################################
set output 'projects/sppifo/plots/sppifo_evaluation/pFabric/web_search_workload/pFabric_packet_drop.pdf'
